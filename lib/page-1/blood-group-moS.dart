                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        padding: EdgeInsets.fromLTRB(18*fem, 85*fem, 19*fem, 107*fem),
                        width: double.infinity,
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Container(
                              ...
                              padding: EdgeInsets.fromLTRB(2*fem, 17.5*fem, 0*fem, 0*fem),
                              width: double.infinity,
                              height: 201.5*fem,
                              child: Container(
                                // group57CL4 (189:1459)
                            ...
                            Container(
                              // group56r6Q (157:259)
                              margin: EdgeInsets.fromLTRB(70*fem, 0*fem, 69*fem, 0*fem),
                              width: double.infinity,
                              height: 83*fem,
                              decoration: BoxDecoration (
                                borderRadius: BorderRadius.circular(20*fem),
